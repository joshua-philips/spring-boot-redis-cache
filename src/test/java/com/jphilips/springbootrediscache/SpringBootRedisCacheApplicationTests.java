package com.jphilips.springbootrediscache;
...
import com.jphilips.springbootrediscache.repository.ProductRepository;
...
class SpringBootRedisCacheApplicationTests {
    ...
    @Container
    @ServiceConnection
    static GenericContainer<?> redis = new GenericContainer<>(DockerImageName.parse("redis:8.4-rc1-alpine3.22"))
    ...
    static void tearDownAll() {
        // Close the container after all tests
        if (redis != null) {
            redis.close();
        }
    }
